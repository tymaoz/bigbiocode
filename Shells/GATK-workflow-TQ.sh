...
for x in ${roots[@]}; do
	...
	#bwa mem -t 10 -M -R '@RG\tID:tauschiiALL\tSM:sample1\tPL:illumina\tLB:lib1\tPU:unit1' ~/WheatD/tauschii-chrom6.2.clean.fa $x/TQ-all-R1_val_1.fq.gz $x/TQ-all-R2_val_2.fq.gz > $x.sam
#	echo SortSam
